...
void			load_instructions(t_corewar *cw)
{
	...
	set_instruction_args(cw->instructions + 6, DISASM_REG | DISASM_DIR | DISASM_IND,
		DISASM_REG | DISASM_DIR | DISASM_IND, DISASM_REG);
	set_instruction_other(cw->instructions + 6, 4, 6, or_function);

	set_instruction_base(cw->instructions + 7, 8, "xor", 1);
	set_instruction_args(cw->instructions + 7, DISASM_REG | DISASM_DIR | DISASM_IND,
		DISASM_REG | DISASM_DIR | DISASM_IND, DISASM_REG);
	...
	set_instruction_args(cw->instructions + 9, DISASM_REG | DISASM_DIR | DISASM_IND,
	...
	set_instruction_args(cw->instructions + 10, DISASM_REG,
	...
	set_instruction_args(cw->instructions + 12,  DISASM_DIR | DISASM_IND, DISASM_REG, 0);
	set_instruction_other(cw->instructions + 12, 4, 10, lld_function);

	set_instruction_base(cw->instructions + 13, 14, "lldi", 1);
	set_instruction_args(cw->instructions + 13, DISASM_REG | DISASM_DIR | DISASM_IND,
		DISASM_REG | DISASM_DIR, DISASM_REG);
