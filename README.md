...
В этом проекте нас просят сделать чемпиона, виртуальную машину(арену) для игры и компилятор с ассемблера в машинный код.
...
### Компилятор
Это программа, которая будет компилировать написанный на языке ассемблера код чемпиона в байт-код, а затем транслировать его в машинный код, который будет интерпретироваться виртуальной машиной напрямую.
...
Этапы:
* Разбор игроков, записанных в машинном коде, сгенерированном из ассемблера
* Настроить среду игры (инициализировать игроков, проверить действующие инструкции машинного кода и т.д.)
